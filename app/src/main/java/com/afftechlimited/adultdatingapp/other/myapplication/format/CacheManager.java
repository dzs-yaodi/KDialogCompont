package com.afftechlimited.adultdatingapp.other.myapplication.format;
...
//        }.execute();
    ...
    public static void save(String key, Object data) {
        ...
        String md5 = md5(key);
        Log.i(TAG, "save# key=" + key + ", md5=" + md5);
    ...
    public static void delete(String key) {
        ...
        String md5 = md5(key);
        Log.i(TAG, "delete# key=" + key + ", md5=" + md5);
